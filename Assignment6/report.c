...
Report_DoReport(Bank *bank, int workerNum)
{
  ...
  if(bank->workingNum == 0){
    ...
    for(int i = 0; i < numWorkers - 1; i++) sem_post(&(bank->doingReport));
